...
locals {
  ...
  # VPC 3 Configuration
  azs_3             = ["ap-southeast-2a", "ap-southeast-2b", "ap-southeast-2c"]
  name_3            = "cltest3"
  base_name_3       = "${local.name_3}-${random_string.suffix.result}"
  private_subnets_3 = ["10.2.101.0/24", "10.2.102.0/24", "10.2.103.0/24"]
  public_subnets_3  = ["10.2.1.0/24", "10.2.2.0/24", "10.2.3.0/24"]
  vpc_cidr_3        = "10.2.0.0/16"

  # Common tags
  suffix = random_string.suffix.result

  vpc_lattice_cidr = "169.254.0.0/16"
